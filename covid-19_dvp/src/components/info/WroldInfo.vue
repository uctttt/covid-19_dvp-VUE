	...
	<div>
		...
		<div class="dailyInfo-body">
			<ul class="dailyInfo-list">
				...
				<li class="info-content">
					<div class="mainData" style="color: rgb(255, 0, 0);">{{ getData(this.confirmedCount) }}</div>
					<div class="dataType">累计确诊</div>
				</li>
				<li class="info-content">
					<div class="mainData" style="color: rgb(0, 180, 0);">{{ getData(this.curedCount) }}</div>
					<div class="dataType">累计治愈</div>
				</li>
				<li class="info-content">
					<div class="mainData" style="color: rgb(80, 80, 80);">{{ getData(this.deadCount) }}</div>
